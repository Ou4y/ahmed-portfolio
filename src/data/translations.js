const translations = {
  en: {
    language: {
      switchLabel: 'Switch the website language to Arabic',
      nextLanguage: 'العربية',
    },
    accessibility: {
    ...
    process: {
      ...
      title: 'A clear path from first question to next steps.',
      description:
        'Each matter begins with context, documents, and priorities so the legal guidance can stay focused and practical.',
      stepLabel: 'Step',
    },
    insights: {
      eyebrow: 'Legal insights',
      title: 'Useful context before the conversation begins.',
      description:
        'Short educational previews covering common legal preparation and business-risk questions.',
      previewLabel: 'Insight preview',
      statusLabel: 'Educational overview',
    },
    faq: {
      eyebrow: 'Frequently asked questions',
      title: 'Helpful answers before you get in touch.',
      description:
        'General guidance about preparing for a consultation and what to expect from the first conversation.',
    },
    contact: {
      eyebrow: 'Contact',
      title: 'Start with the legal question in front of you.',
      description:
        'Share a brief overview of your matter and the relevant documents. Availability, scope, and fees can then be confirmed before any engagement begins.',
    ...
    footer: {
      ...
      disclaimer:
        'The information on this website is provided for general informational purposes only and does not constitute legal advice. Contacting the office does not create an attorney-client relationship unless formally agreed in writing.',
  ...
  ar: {
    language: {
      switchLabel: 'تغيير لغة الموقع إلى الإنجليزية',
    ...
    process: {
      eyebrow: 'خطوات الاستشارة',
      title: 'مسار واضح من السؤال الأول إلى الخطوات التالية.',
      description:
        'تبدأ كل مسألة بفهم السياق والمستندات والأولويات، حتى يظل الإرشاد القانوني مركزًا وعمليًا.',
      stepLabel: 'الخطوة',
    },
    insights: {
      eyebrow: 'رؤى قانونية',
      title: 'معلومات مفيدة قبل بدء الحوار.',
      description:
        'موضوعات تعريفية مختصرة حول الاستعداد القانوني والأسئلة الشائعة المتعلقة بمخاطر الأعمال.',
      previewLabel: 'موضوع تعريفي',
      statusLabel: 'محتوى توعوي',
    },
    faq: {
      eyebrow: 'أسئلة شائعة',
      title: 'إجابات تساعدك قبل التواصل.',
      description:
        'إرشادات عامة حول الاستعداد للاستشارة وما يمكن توقعه من التواصل الأولي.',
    },
    contact: {
      eyebrow: 'تواصل',
      title: 'ابدأ بالمسألة القانونية التي تحتاج إلى توضيح.',
      description:
        'شارك نبذة مختصرة عن المسألة والمستندات ذات الصلة، ثم يمكن تأكيد التوافر ونطاق العمل والأتعاب قبل بدء أي تكليف.',
    ...
    footer: {
      ...
      disclaimer:
        'المعلومات الموجودة في هذا الموقع لأغراض تعريفية عامة فقط ولا تعتبر استشارة قانونية. التواصل مع المكتب لا ينشئ علاقة محامٍ وموكل إلا بعد الاتفاق الرسمي على ذلك.',
